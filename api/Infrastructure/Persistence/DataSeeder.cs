...
public static class DataSeeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        var platform = new Program_ { Id = Guid.NewGuid(), Name = "Platform" };
        var growth   = new Program_ { Id = Guid.NewGuid(), Name = "Growth" };
        var infra    = new Program_ { Id = Guid.NewGuid(), Name = "Infrastructure" };

        var auth = new Project { Id = Guid.NewGuid(), ProgramId = platform.Id, Name = "Auth & Identity",       Key = "AUTH", Color = "#7c5cff" };
        var bil  = new Project { Id = Guid.NewGuid(), ProgramId = platform.Id, Name = "Billing v2",            Key = "BIL",  Color = "#4cc9e7" };
        var onb  = new Project { Id = Guid.NewGuid(), ProgramId = platform.Id, Name = "Onboarding rework",     Key = "ONB",  Color = "#f0b34a" };
        var act  = new Project { Id = Guid.NewGuid(), ProgramId = growth.Id,   Name = "Activation funnels",    Key = "ACT",  Color = "#4ade80" };
        var refs = new Project { Id = Guid.NewGuid(), ProgramId = growth.Id,   Name = "Referrals",             Key = "REF",  Color = "#f87171" };
        var obs  = new Project { Id = Guid.NewGuid(), ProgramId = infra.Id,    Name = "Observability",         Key = "OBS",  Color = "#a78bfa" };
        var mig  = new Project { Id = Guid.NewGuid(), ProgramId = infra.Id,    Name = "Postgres 16 migration", Key = "MIG",  Color = "#94a3b8" };
